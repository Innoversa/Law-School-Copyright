...
"color:rgb(255,255,255);")
        ...
        self.label.setGeometry(QtCore.QRect(60, 70, 301, 16))
        ...
        self.label_output = QtWidgets.QLabel(self.right_frame)
        self.label_output.setGeometry(QtCore.QRect(60, 100, 301, 16))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_output.setText(_translate("MainWindow", "Please select output directory..."))
